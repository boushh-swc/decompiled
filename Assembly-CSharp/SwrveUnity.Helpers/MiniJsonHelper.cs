...
namespace SwrveUnity.Helpers
{
	public static class MiniJsonHelper
	{
		...
		{
			return MiniJsonHelper.GetInt(json, key, 0);
		}
		...
		{
			return MiniJsonHelper.GetLong(json, key, 0L);
		}
		...
		{
			return MiniJsonHelper.GetFloat(json, key, 0f);
		}
		...
		{
			return MiniJsonHelper.GetBool(json, key, false);
		}
		...
		{
			return MiniJsonHelper.GetString(json, key, null);
		}
